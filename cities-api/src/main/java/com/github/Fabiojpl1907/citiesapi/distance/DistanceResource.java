package com.github.Fabiojpl1907.citiesapi.distance;

import com.github.Fabiojpl1907.citiesapi.cities.services.DistanceService;
...
/*   @GetMapping("/by-math")
    public Double byMath(@RequestParam(name = "from") final Long city1,
        ...
        log.info("byMath");
        return service.distanceUsingMath(city1, city2, unit);unit
    }*/
}
